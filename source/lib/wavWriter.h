...
#pragma pack(pop)
	...
	{
	public:
		static bool write(const std::string& _filename, const std::vector<uint8_t>& data, int bitsPerSample, bool isFloat, int _channelCount, int _samplerate, std::vector<CuePoint>* _cuePoints = nullptr);
	};
};
